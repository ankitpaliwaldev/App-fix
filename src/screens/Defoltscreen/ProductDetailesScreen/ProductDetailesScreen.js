    ...
    <View style={DetailsScreenStyles.minstyleviewphotograpgy}>
      ...
      <ScrollView
        ...
        <KeyboardAvoidingView enabled>
          <View
            style={[
              DetailsScreenStyles.minflexview,
              DetailsScreenStyles.bgcolorset,
            ]}>
            <View
              style={[
                DetailsScreenStyles.minviewsigninscreen,
                DetailsScreenStyles.bgcolorset,
              ]}>
              ...
              <TouchableOpacity
                onPress={() => backarrow()}
                style={DetailsScreenStyles.settextstyle}>
              ...
              <View
                style={[
                  DetailsScreenStyles.bgwhiteboxminview,
                  DetailsScreenStyles.bgcolorset,
                ]}>
                ...
                <View
                  style={[
                    DetailsScreenStyles.setallpading,
                    DetailsScreenStyles.bgcolorset,
                  ]}>
                  <View
                    style={[
                      DetailsScreenStyles.descripitionviewone,
                      DetailsScreenStyles.bgcolorset,
                    ]}>
                    <Text style={DetailsScreenStyles.descriptiontextset}>
                      {'Product Description'}
                    </Text>
                    <Text style={DetailsScreenStyles.paregraphtextset}>
                      {/* {t('Discription_Item_Label')} */}
                      {description}
                    </Text>
                  </View>
                  <View
                    style={[
                      DetailsScreenStyles.descripitionviewtwo,
                      DetailsScreenStyles.bgcolorset,
                    ]}>
                    <View style={[DetailsScreenStyles.borderbottomview]}>
                      <Text style={DetailsScreenStyles.nuteialtext}>
                        {'Additional Info:'}
                      </Text>
                    ...
                    <View style={DetailsScreenStyles.thretexztflexviewtwo}>
                      <View style={DetailsScreenStyles.flexclockandtextwo}>
                        <VectoreIcons
                          ...
                          color={Colors.bittersweet_color}
                          size={SF(14)}
                        />
                        <Text style={DetailsScreenStyles.textcolorgray}>
                          {t('Food_Item_Cal_Label')}
                        </Text>
                      </View>
                      <View>
                        <Text style={DetailsScreenStyles.textcolorgraytwo}>
                          {t('Daily_value_Label')}
                        </Text>
                      </View>
                    </View>
      ...
      <View style={DetailsScreenStyles.setbgcolorviewtwo}>
        ...
        <View>
          <TouchableOpacity
            style={DetailsScreenStyles.setbgcolorwhite}
